...
public class ClienteController {
      ...
      public ResponseEntity<BaseResponse> getById(@PathVariable Integer idCliente) throws ClientException {
      ...
      public ResponseEntity<BaseResponse> edit(@PathVariable Integer idCliente, @RequestBody Cliente cliente) throws ClientException {
      ...
      public ResponseEntity<BaseResponse> remove(@PathVariable Integer idCliente) throws ClientException{
