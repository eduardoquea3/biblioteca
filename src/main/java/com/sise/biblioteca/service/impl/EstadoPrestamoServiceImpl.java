...
public class EstadoPrestamoServiceImpl implements IEstadoPrestamoService {
  ...
  @Autowired private IEstadoPrestamoRepository estadoPrestamoRepository;
  ...
  public EstadoPrestamo getById(Integer idEstado) throws ClientException {
    EstadoPrestamo estadoPrestamo =
        estadoPrestamoRepository.findOneByIdEstadoPrestamoAndEstado(idEstado, true);
  ...
  public EstadoPrestamo edit(Integer id, EstadoPrestamo newEstadoPrestamo) throws ClientException {
    EstadoPrestamo estadoPrestamo =
        estadoPrestamoRepository.findOneByIdEstadoPrestamoAndEstado(id, true);
    if (estadoPrestamo == null) throw new ClientException(" no existe", HttpStatus.NOT_FOUND);
