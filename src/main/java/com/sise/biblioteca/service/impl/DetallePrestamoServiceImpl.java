...
public class DetallePrestamoServiceImpl  implements IDetallePrestamoService{
      ...
      public Page<DetallePrestamo> getAll(Pageable pageable)  {
            return detallePrestamoRepository.findByIdDetallePrestamo(true, pageable);
           
      }

      @Override
      public DetallePrestamo getById(Integer idDetalleprestamo) throws ClientException {
           DetallePrestamo detallePrestamo = detallePrestamoRepository.findOneByIdDetallePrestamoAndEstado(idDetalleprestamo, true);
      ...
      @Override
      public DetallePrestamo edit(Integer id, DetallePrestamo newDetallePrestamo) throws ClientException {
         DetallePrestamo detallePrestamo = detallePrestamoRepository.findOneByIdDetallePrestamoAndEstado(id, true);
         if(detallePrestamo == null)
